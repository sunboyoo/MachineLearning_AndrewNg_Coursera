...
% LEARNINGCURVE Generates the train and cross validaton set errors needed
...
% i.e., error_train(i) and error_val(i)
% should give you the errors obtained after training on i examples.

% NOTE: You should evaluate the training error on the first i training examples
% i.e., X(1:i,:) and y(1:i).
% For the cross validation error, you should instead evaluate on the entire 
...
theta = zeros(size(X,2),1); % Vector(n+1,1)
for i = 1:m
